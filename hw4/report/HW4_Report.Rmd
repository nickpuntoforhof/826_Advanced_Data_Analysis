...
```
These numbers can be roughly interpreted as the average absolute error of the predictions, consider the given variable had been perturbed. Not a whole not can be said here -- it can be observed age is clearly the most important variable. 